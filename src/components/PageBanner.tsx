  ...
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-r from-primary/10 to-primary/20 overflow-hidden">
      ...
      {showIcons && (
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          <div className="container mx-auto h-full relative">
            <HandHelping className="absolute top-1/4 left-10 md:left-20 h-16 w-16 md:h-20 md:w-20 text-primary transform rotate-12" />
            <Users className="absolute bottom-1/4 right-10 md:right-24 h-14 w-14 md:h-16 md:w-16 text-primary transform -rotate-6" />
            <Heart className="absolute top-1/2 left-1/2 h-10 w-10 md:h-12 md:w-12 text-primary transform -translate-x-1/2 -translate-y-1/2" />
          </div>
        </div>
      )}
      ...
      <div className="container relative mx-auto px-4 text-center z-10">
        ...
        {/* Banner highlighting therapeutic relationship */}
        <div className="mt-8 max-w-4xl mx-auto bg-white/80 backdrop-blur-sm rounded-lg p-4 md:p-6 shadow-elegant border border-primary/10">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
            <div className="flex-shrink-0 bg-primary/10 p-3 rounded-full">
              <HandHelping className="h-8 w-8 text-primary" />
            </div>
            <div className="text-left">
              <h3 className="text-lg md:text-xl font-semibold text-foreground mb-1">Professional Support When You Need It</h3>
